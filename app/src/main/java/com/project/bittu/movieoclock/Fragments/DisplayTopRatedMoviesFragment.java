 ...
 */
public class DisplayTopRatedMoviesFragment extends Fragment {
    ...
    private static DisplayTopRatedMoviesFragment fragment = null;

    public static DisplayTopRatedMoviesFragment fragmentInstance(int type){

        if(fragment == null) {
            fragment = new DisplayTopRatedMoviesFragment();
            Bundle b = new Bundle();
            b.putInt("TYPE", type);
